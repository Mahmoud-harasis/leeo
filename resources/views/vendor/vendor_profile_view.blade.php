                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src="{{ (!empty($vendorData->photo)) ? url('upload/vendor_images/'.$vendorData->photo) : url('upload/no_image.jpg') }}" alt="Admin" class="rounded-circle p-1" width="110">
                                <div class="mt-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <textarea name="vendor_short_info" class="form-control" id="inputAddress" placeholder="Vendor Info" rows="3">{{$vendorData->vendor_short_info}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <img id="showImage" src="  {{ (!empty($vendorData->photo)) ? url('upload/vendor_images/'.$vendorData->photo) : url('upload/no_image.jpg') }}" alt="vendor" class="rounded-circle p-1" width="110">
                                </div>
                            </div>
                            <div class="row">
