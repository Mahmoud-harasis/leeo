                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <ul class="language-dropdown">
                                        ...
                                        <li>
                                            <a href="#"><img src="{{asset('frontend/assets/imgs/theme/flag-ru.pn')}}g" alt="" />Pусский</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="{{asset('frontend/assets/imgs/shop/product-16-1.jpg')}}" alt="" />
                                                <img class="hover-img" src="{{asset('frontend/assets/imgs/shop/product-16-2.jp')}}g" alt="" />
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Add To Wishlist" class="action-btn" href="shop-wishlist.html"><i class="fi-rs-heart"></i></a>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-4 col-lg-6 text-center d-none d-xl-block">
                    ...
                    <div class="hotline d-lg-inline-flex">
                        <img src="{{asset('frontend/assets/imgs/theme/logo.svg')}}" alt="hotline" />
